...
/* package GO-runfct-0.1.0.0 */
#ifndef VERSION_GO_runfct
#define VERSION_GO_runfct "0.1.0.0"
#endif /* VERSION_GO_runfct */
#ifndef MIN_VERSION_GO_runfct
#define MIN_VERSION_GO_runfct(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_GO_runfct */
...
/* package funcons-tools-0.2.0.15 */
#ifndef VERSION_funcons_tools
#define VERSION_funcons_tools "0.2.0.15"
#endif /* VERSION_funcons_tools */
#ifndef MIN_VERSION_funcons_tools
#define MIN_VERSION_funcons_tools(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_funcons_tools */
/* package funcons-values-0.1.0.9 */
#ifndef VERSION_funcons_values
#define VERSION_funcons_values "0.1.0.9"
#endif /* VERSION_funcons_values */
#ifndef MIN_VERSION_funcons_values
#define MIN_VERSION_funcons_values(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_funcons_values */
...
#define CURRENT_COMPONENT_ID "GO-runfct-0.1.0.0-inplace-GO-runfct"
